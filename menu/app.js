  ...
  filterBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      ...
      if (category === 'all') {
        ...
        getDisplayMenuItems(filterCategory);
      }
    });
  });
});

//  display filter buttons & filter it according to the categories

// display all the Items
function getDisplayMenuItems(menuItem) {
